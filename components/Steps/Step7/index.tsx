...
export default function Step7({ nextStep, previousStep }: { nextStep: any, previousStep: any }) {
  ...
  useEffect(() => {
    if (localStorage.getItem('@teste-vocacional:problem_situation')) {
      setSelected(localStorage.getItem('@teste-vocacional:problem_situation') || "");
    }
  ...
  return (
    <Hero title="" onClick={() => handleSubmit()} percentage="50" previousStep={previousStep} subtitle="Quando alguém se acidenta, você:" imageSize="small">
      <FormContainer>
