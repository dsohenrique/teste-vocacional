...
export default function Step4({ nextStep, previousStep }: { nextStep: any, previousStep: any }) {
  ...
  return (
    <Hero title="" percentage="20" previousStep={previousStep} subtitle={`Perfeito, ${name}! Então vamos começar te conhecendo um pouco melhor. Qual é o seu momento atual de carreira?`} imageSize="small">
        <FormContainer>
